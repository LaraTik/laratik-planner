    ...
    return (
      <form action={signOutAction} data-testid="sign-out-form">
        <button
          ...
          className="text-body text-fg-primary hover:bg-surface-subtle flex w-full items-center gap-2 rounded-[var(--radius-control)] px-2.5 py-1.5 text-left font-semibold"
        >
