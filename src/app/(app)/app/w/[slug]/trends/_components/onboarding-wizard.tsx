...
export function OnboardingWizard({
  ...
  return (
    <div
      ...
      className="bg-surface-card border-border backdrop:bg-fg/40 fixed inset-0 z-50 overflow-y-auto border p-6"
    >
          ...
          {freeSources.map((source) => {
            ...
            return (
              <li
                ...
                className={`border-border bg-surface-subtle flex flex-col gap-2 rounded-[var(--radius-card)] border p-3 ${
