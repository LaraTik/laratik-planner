...
export default async function SocialAnalyticsPage({
  ...
  const labels: DashboardLabels = {
    ...
    accountFilterDescription: t("analytics.accountFilterDescription"),
    allPlatforms: t("analytics.allPlatforms"),
    clear: t("analytics.clear"),
    selectAll: t("analytics.selectAll"),
    allAccounts: t("analytics.allAccounts"),
    ...
    comparisonLegend: t("analytics.comparisonLegend"),
    showSeries: t("analytics.showSeries"),
    hideSeries: t("analytics.hideSeries"),
