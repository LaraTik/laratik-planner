...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ...
    className={cn(
      ...
      "border-border bg-surface text-primary-foreground focus-visible:ring-focus-ring peer h-4 min-h-0 w-4 shrink-0 rounded-[2px] border focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none",
