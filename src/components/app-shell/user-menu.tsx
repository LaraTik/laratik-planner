...
export function UserMenu({
  ...
  return (
    <div className="flex items-center gap-2">
      <Link
        href="/app/account"
        className="border-border bg-surface text-fg-primary hover:bg-surface-subtle text-label focus-visible:ring-focus-ring flex min-h-11 min-w-11 items-center gap-2 rounded-full border px-2 py-2 font-semibold transition-colors focus:outline-none focus-visible:ring-2"
      >
