...
| 3     | Root shell, sidebar, mobile nav, account, notifications, agency/workspace switchers      | **In progress**               | Phase 3a (commit f3fb0b9): notifications bell + user menu (desktop + mobile variant) + topbar / mobile-topbar bilingual chrome. Sidebar navigation labels (40+ keys) deferred to Phase 3b.                                                                                                                  |
