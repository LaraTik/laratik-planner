...
| 4     | My Work, workspace overview, planning list, board, calendar, Quick Create, Batch Add     | **In progress**               | Phase 4a (92d3392): My Work dashboard — KPI labels, section headings, empty states, locale-aware date formatting all sourced from the message catalog. Workspace overview, planning list/board/calendar, Quick Create, Batch Add deferred to subsequent Phase 4 batches.                                                    |
