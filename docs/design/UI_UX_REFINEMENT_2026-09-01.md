...
| 5     | Content detail, editing, format payload, translations, AI assistance, comments, activity | **In progress**               | Phase 5a (f2ef52d): content detail header — 4 readiness row labels + 14 detail variants, Creative brief + Assets & versions sections, preview shortcut, nextActionLabel() helper. Format editor + AI + comments + activity deferred.                                                                                        |
