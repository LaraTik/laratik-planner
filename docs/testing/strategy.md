...
| Coverage      | `pnpm test:coverage`                                 | Enforces the thresholds recorded in the production tracker. HTML and LCOV evidence are generated under `coverage/`.                                                                           |
| Browser       | `pnpm test:e2e`                                      | Chromium, Firefox, WebKit, mobile Chrome, and mobile Safari journeys with separated role identities.                                                                                          |
